    ...
    return (
      <section>
        <div className="page-head">
          ...
          <p>เฉพาะ HEAD เท่านั้นที่จัดการธีม WordPress ได้</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section>
      <div className="page-head">
        ...
        <p>
          จัดการแพ็กเกจธีม WordPress, รูปตัวอย่าง, เวอร์ชัน และ update manifest
          สำหรับเว็บปลายทาง
        </p>
      </div>
      ...
      <div className="panel">
        ...
        <div className="content-themes-panel">
          <div className="about-theme">
            <p className="hint">
              ปุ่มนี้ยังคง zip ธีม <code>wordpress-theme/aurum-video</code> จาก
              source ปัจจุบัน เหมาะสำหรับดาวน์โหลดเวอร์ชัน built-in
              หรือใช้เป็นไฟล์ต้นทางเพื่ออัปโหลดเข้าระบบจัดการธีมด้านล่าง
            </p>
            <a
              className="btn btn-gold"
              href="/api/wp-theme/download"
