 ...
 * Description: AURUM video management, site profiles, safe CSV editing, metadata, playback, diagnostics, and video SEO.
 * Version: 1.3.0
...
define( 'AURUM_VIDEO_CORE_VERSION', '1.3.0' );
...
require_once AURUM_VIDEO_CORE_DIR . 'includes/site-profile.php';
require_once AURUM_VIDEO_CORE_DIR . 'includes/actor-sync.php';
require_once AURUM_VIDEO_CORE_DIR . 'includes/player.php';
require_once AURUM_VIDEO_CORE_DIR . 'includes/editor-persistence.php';
require_once AURUM_VIDEO_CORE_DIR . 'includes/seo.php';
require_once AURUM_VIDEO_CORE_DIR . 'includes/audit.php';
require_once AURUM_VIDEO_CORE_DIR . 'includes/csv.php';
require_once AURUM_VIDEO_CORE_DIR . 'includes/admin.php';
